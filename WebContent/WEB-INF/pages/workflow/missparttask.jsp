...
<body>
	<div id="tabsTask">
		...
		<div title="缺件详情" data-options="closable:false">
			<div region="center" title="缺件详情" border="false">
		    	<form id="formQuailty" columns='1' class="easyui-form">
		      		...
		      		<input title="缺件物料号" name="materialCode" type="text" class="easyui-validatebox" disabled style="width:400px;"/>
		      		<input title="缺件数量" name="materialNum" type="text" class="easyui-validatebox" disabled style="width:400px;"/>
		    	</form>
		  	</div>
		</div>
	</div>
