		...
		<div title="任务办理" data-options="closable:false,selected:true">
			<div class="easyui-layout" fit="true">
				<div region="center" border="false">
					...
					<a class="easyui-linkbutton" onClick="btnTask('驳回');" iconCls="icon-cancel" style="margin-left:60px;">驳回</a>
					<a class="easyui-linkbutton" onClick="btnTask('通过');" iconCls="icon-ok" style="margin-left:20px;">通过</a>
			  	</div>
...
<script type="text/javascript">
	...
	function btnTask(obj){
		...
		ctrl.operPost("${app}/workflow/doReviewTask.do", param, function(paraMap){
