...
<body class="easyui-layout">
	<div region="center" border="false">
	   <form id="formPstAdd" columns='1' class="easyui-form">
			...
			<input title="所属部门" id="orgNam" name="orgNam" style="width:300px;" value="${param.orgNam}" readonly="readonly" disabled="disabled"/>
	...
	<div region="south" border="false" style="text-align:right;float:right;padding:3px;" class="htborder-top">
		<a class="easyui-linkbutton" onClick="btnPstAdd(this);" iconCls="icon-save">保存</a> &nbsp;&nbsp;
...
<script type="text/javascript">
	...
	//保存新增岗位
	function btnPstAdd(obj) {
		//保存之前需要前台校验
		var valid = $("#formPstAdd").form("validate");
		if(!valid) return;
		
		ctrl.operPost("${app}/sys/pst/addPst.do",$("#formPstAdd").form("getData"), function(paraMap){
			parent.queryPstDataGridByOrgID();
