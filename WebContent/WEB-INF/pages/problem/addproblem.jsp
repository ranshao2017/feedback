...
<body class="easyui-layout">
	<div region="center" border="false" style="padding:10px">
    	<form id="formProblem" columns='1' class="easyui-form">
      		<textarea title="问题描述" name="descr" rows='7' style="width:400px;" required="true" class="easyui-validatebox"></textarea>
      		<input type="hidden" name="imgPath" id="imgPath"/>
      		<input title="问题类别" id="proType" name="proType" syscode="PROTYPE" class="easyui-combobox" panelHeight="auto" required="true"/>
    	</form>
...
<script type="text/javascript">
	...
	function btnSaveProblem(obj) {
    	...
    	if(!valid) return;
    	ctrl.operPost("${app}/problem/addProblem.do", $("#formProblem").form("getData"), function(paraMap){}, obj);    
  	}
</script>
</html>