...
<body class="easyui-layout">
	...
	<div region="south" style="text-align:center;padding:3px;">
		<a class="easyui-linkbutton" onClick="submitUTC(this);" iconCls="icon-ok">调 车</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a class="easyui-linkbutton" onClick="saveUXx(this);" iconCls="icon-exclam">缺件不可调车</a>
	</div>
</body>
<script type="text/javascript">
	...
	function submitUTC(obj){
    	...
    	ctrl.operPost("${app}/cartest/submitUTC.do", param, function(paraMap){
    		parent.queryCT();
      		parent.ctrl.closeWin();
    	}, obj);
	}
	
	function saveUXx(obj){
		var valid = $("#formPickCar").form("validate");
    	if(!valid) return;
		if (editRow != undefined) {
            $("#qj_DG").datagrid('endEdit', editRow);
    	...
    	ctrl.operPost("${app}/cartest/saveUXx.do", param, function(paraMap){
    		parent.queryCT();
      		parent.ctrl.closeWin();
    	}, obj);
	}
